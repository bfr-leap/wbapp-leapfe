...
<template>
    <LeagueSeasonMenu target-page="season" v-bind:league="seasonProfileModel.leagueId"
    ...
    <div class="card bg-dark text-light m-2">
        <div class="card-body p-2">
            ...
            <div class="container">
                <PastEventCards v-bind:league="seasonProfileModel.leagueId" v-bind:season="seasonProfileModel.seasonId">
                </PastEventCards>
            </div>
            <div style="height: 1em"></div>
        </div>
    ...
    <template v-for="split in statSplit">
        <div class="card bg-dark text-light m-2">
            <div class="card-body p-2">
                ...
                <ul class="nav nav-pills">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item active" data-bs-toggle="tab"
                                    v-bind:data-bs-target="`#nav-inc-chart-${split}`" href="#">
                                    Incidents per Lap
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" data-bs-toggle="tab"
                                    v-bind:data-bs-target="`#nav-par-chart-${split}`" href="#">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" data-bs-toggle="tab"
                                    v-bind:data-bs-target="`#nav-sts-table-${split}`" href="#">
                                    Season Stats
                                </a>
                            </li>
                        </ul>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" v-bind:id="`nav-inc-chart-${split}`" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-12 m-auto">
                                <BarChart v-if="getChartDataFromStats(
        seasonProfileModel.stats,
        'incidents_per_lap',
        split
    ).length
        " :data="getChartDataFromStats(
        seasonProfileModel.stats,
        'incidents_per_lap',
        split
    )
        " />
                    ...
                    <div class="tab-pane fade" v-bind:id="`nav-par-chart-${split}`" role="tabpanel"
                        aria-labelledby="nav-home-tab" tabindex="0">
                        <div class="row">
                            <div class="col-12 m-auto">
                                number of participants
        ...
        " />
                    ...
                    <div class="tab-pane fade" v-bind:id="`nav-sts-table-${split}`" role="tabpanel"
                        aria-labelledby="nav-home-tab" tabindex="0">
                        <div class="row">
                            <GenericTable :title="`Season Stats - ${split}`" :league-id="seasonProfileModel.leagueId"
                                :rows="seasonProfileModel.stats[split]" :season-id="seasonProfileModel.seasonId" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div v-if="seasonProfileModel.nextRace.date !== ''" class="card bg-dark text-light m-2">
        <div class="card-body p-2">
            <div class="container">
                ...
                <div v-if="seasonProfileModel.nextRace.date !== ''" class="row g-1">
                    <div class="col-12 col-sm-3 col-lg-2">
                        <div class="row g-1 flex-sm-column h-100">
                            <div class="col" @click="onClick(seasonProfileModel.nextRace)">
                                <EventCardSm class="h-100" v-bind:track_id="seasonProfileModel.nextRace.trackId
        " v-bind:is_next="true" v-bind:date="new Date(
        seasonProfileModel.nextRace.date
    )
        " v-bind:is_selected="seasonProfileModel.nextRace.isSelected
        "></EventCardSm>
                            </div>
                            <div v-for="race in seasonProfileModel.futureRaces" class="col" @click="onClick(race)">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10">
                        <EventCardLg v-bind:track_id="seasonProfileModel.selectedRace.trackId.toString()
        " v-bind:car_id="seasonProfileModel.carId" v-bind:league_id="seasonProfileModel.leagueId"
                            v-bind:is_next="false" v-bind:date="new Date(seasonProfileModel.selectedRace.date)
        "></EventCardLg>
                    </div>
                </div>
