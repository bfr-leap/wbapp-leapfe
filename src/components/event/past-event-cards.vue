...
<template>
    <div class="row g-1">
        <div class="col-12">
            <div v-if="pastEventCardsModel.pastRaces.length" class="row g-1 h-100">
                <div v-for="race in pastEventCardsModel.pastRaces" class="col">
                    <RouterLink style="text-decoration: none" class="link-light"
                        ...
                        <EventCardSm class="h-100" v-bind:track_id="race.trackId" v-bind:is_next="false"
                            v-bind:date="new Date(race.date)" v-bind:is_selected="race.isSelected"></EventCardSm>
                    </RouterLink>
                </div>
            </div>
